...
local DiscordFooter = makeLabel(Window, "DiscordFooter", "discord.gg/aceduels", UDim2.fromOffset(140, 19), UDim2.new(0.5, -70, 0, 346), 10, COLORS.White, Enum.Font.GothamBold)
...
function flashCode(code, col)
    if not code or code == "" or code == "â€”" then return end
